...
var memery = module.exports = {
    ...
    EFRONT: false,
    EFRONTUP: get("EFRONTUP", 1200),
    EFRONTSUM: get("EFRONTSUM", 2000000),
    ...
    LOCAL_HOSTS: get("LOCAL_HOSTS,LOCAL_HOST,LOCALHOSTS,LOCALHOST,HOSTS,HOST"),
    ...
    PFX_PASSWORD: get("PFX_PASSWORD, SSL_PASSWORD, PASSWORD.SSL_PFX", ''),// 目前仅用于服务器
