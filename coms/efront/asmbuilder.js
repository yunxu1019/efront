...
var operators = /^(ifn?def|else|endif|echo|option|include(lib)?|local|end|invoke|call|push|pop|lea|ret|mov|xor|and|not|or|cmp|jmp|jn?[ez]|sh[rl]|(fi?)?(add|div|mul|sub)|fi?(stp|ld)f(chs|ld1|init)|\.\w+)(\s|$)/i;
function clean() {
    queue = [];
    datas = {};
    procsMap = {};
