var emojiFactory = {
    formatHTMLToSend: function (e) {
        var t = this;
        return utilFactory.htmlDecode(utilFactory.clearHtmlStr(e.replace(/<(?:img|IMG).*?text="(.*?)".*?>/g, function (e, t) {
    ...
    transformSpanToImg: function (e) {
        ...
        return e && e.replace(/<span.*?class="emoji emoji(.*?)"><\/span>/g, function () {
            ...
            return utilFactory.genEmoticonHTML("emoji emoji" + arguments[1], e || "")
        })
    },
    emoticonFormat: function (e) {
        var t = this;
        return 0 == e.length ? "" : (e = e.replace(new RegExp("(\\[.+?\\])(?!" + confFactory.MM_EMOTICON_WEB + ")", "g"), function (e, a) {
                return t.getEmoticonByText(a) || e
            }).replace(new RegExp("&lt;(.+?)&gt;(?!" + confFactory.MM_EMOTICON_WEB + ")", "g"), function (e, a) {
                return t.getEmoticonByText("<" + a + ">") || e
            }),
    ...
    getEmoticonById: function (e) {
        ...
        return t ? utilFactory.genEmoticonHTML("emoji emoji" + e, t) : ""
    },
    getEmoticonByText: function (e) {
        var t;
        if (e.indexOf("<") > -1) {
            if (t = this.QQFaceMap[e])
                return utilFactory.genEmoticonHTML("emoji emoji" + t, this.EmojiCodeMap[t])
        } else if (t = this.QQFaceMap[e.replace(/\[|\]/g, "")])
            return utilFactory.genEmoticonHTML("qqemoji qqemoji" + t, e);
        return null
    },
...
emojiFactory.TuzkiList = function () {
    var e = [],
        t = emojiFactory.Tuzki2Md5;
    for (var a in t)
        e.push(a);
    return e
}();