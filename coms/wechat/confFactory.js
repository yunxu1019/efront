var host = "wx2.qq.com",//location.host
    loginhost = "login.weixin.qq.com",
    filehost = "file.wx.qq.com",
    pushhost = "webpush.weixin.qq.com";
host.indexOf("wx2.qq.com") > -1 ? (loginhost = "login.wx2.qq.com",
    filehost = "file.wx2.qq.com",
    pushhost = "webpush.wx2.qq.com") : host.indexOf("wx8.qq.com") > -1 ? (loginhost = "login.wx8.qq.com",
        filehost = "file.wx8.qq.com",
        pushhost = "webpush.wx8.qq.com") : host.indexOf("qq.com") > -1 ? (loginhost = "login.wx.qq.com",
            filehost = "file.wx.qq.com",
            pushhost = "webpush.wx.qq.com") : host.indexOf("web2.wechat.com") > -1 ? (loginhost = "login.web2.wechat.com",
                filehost = "file.web2.wechat.com",
                pushhost = "webpush.web2.wechat.com") : host.indexOf("wechat.com") > -1 && (loginhost = "login.web.wechat.com",
                    filehost = "file.web.wechat.com",
                    pushhost = "webpush.web.wechat.com");
var language = navigator.language || navigator.browserLanguage;
language || (language = "zh-cn"),
    language = language.split("-"),
    language = language[0].toLowerCase() + "_" + (language[1] || "").toUpperCase();
var confFactory = {
    LANG: language,
    EMOTICON_REG: 'img\\sclass="(qq)?emoji (qq)?emoji([\\da-f]*?)"\\s(text="[^<>(\\s]*")?\\s?src="[^<>(\\s]*"\\s*',
    RES_PATH: "/zh_CN/htmledition/v2/",
    API_jsLogin: "https://" + loginhost + "/jslogin?appid=wx782c26e4c19acffb&redirect_uri=" + encodeURIComponent(location.protocol + "//" + location.host + "/cgi-bin/mmwebwx-bin/webwxnewloginpage") + "&fun=new&lang=" + language,
...
extend(confFactory, {
    RES_IMG_DEFAULT: confFactory.RES_PATH + "images/img.gif",
    RES_IMG_PLACEHOLDER: confFactory.RES_PATH + "images/spacer.gif",
    RES_SOUND_RECEIVE_MSG: confFactory.RES_PATH + "sound/msg.mp3",
    RES_SOUND_SEND_MSG: confFactory.RES_PATH + "sound/text.mp3"
}),
    /mmdebug=local/.test(document.location.search) && extend(confFactory, {
