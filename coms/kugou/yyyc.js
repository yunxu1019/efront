// 网易云音乐代码片段
var CryptoJS = thirdParty$crypto;
var emj = {
    "色": "00e0b",
    "流感": "509f6",
    "这边": "259df",
...
var md0 = ["流泪", "强"].map(e => emj[e]).join('');
var md = ["色", "流感", "这边", "弱", "嘴唇", "亲", "开心", "呲牙", "憨笑", "猫", "皱眉", "幽灵", "蛋糕", "发怒", "大哭", "兔子", "星星", "钟情", "牵手", "公鸡", "爱意", "禁止", "狗", "亲亲", "叉", "礼物", "晕", "呆", "生病", "钻石", "拜", "怒", "示爱", "汗", "小鸡", "痛苦", "撇嘴", "惶恐", "口罩", "吐舌", "心碎", "生气", "可爱", "鬼脸", "跳舞", "男孩", "奸笑", "猪", "圈", "便便", "外星", "圣诞"].map(e => emj[e]).join("");
var md2 = ["爱心", "女孩", "惊恐", "大笑"].map(e => emj[e]).join('');
...
function biMultiply(a, b) {
    var h, c = new BigInt, e = biHighIndex(a), f = biHighIndex(b);
    for (var k = 0; f >= k; ++k) {
        for (var d = 0,
            i = k,
            j = 0; e >= j; ++j,
...
return function () {
    ...
    return {
        asrsea: d,
        encode(a) {
            var p = d(JSON.stringify(a));
            return { params: p.encText, encSecKey: p.encSecKey };
        },
        ecnonasr: e
    }
}();
