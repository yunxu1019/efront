// <!--
if (typeof i18n === "undefined") i18n = require("../basic/i18n");
// -->
var helps = [
    ...
    ["-", i18n`当前文件夹启动开发环境服务器，仅用于外部非工程测试`, "live.", "lives.", "live. HTTP_PORT", "live. HTTP_PORT HTTPS_PORT", "lives. HTTPS_PORT", "lives. HTTPS_PORT HTTP_PORT"],
    ...
    ["-", i18n`在当前文件夹启动生产环境服务器，用于临时无鉴权服务器搭建`, "start.", "starts.", "start. HTTP_PORT", "start. HTTP_PORT HTTPS_PORT", "starts. HTTPS_PORT", "starts. HTTPS_PORT HTTP_PORT"],
    ...
    ["a", i18n`在当前文件夹启动服务器，以处理核心数为准启动多个子进程`, "server", "serve|serv|http HTTP_PORT HTTPS_PORT", "serve|serv|http HTTP_PORT", "https HTTPS_PORT HTTP_PORT", "https HTTPS_PORT", "HTTP_PORT HTTPS_PORT", "HTTP_PORT", ""],
