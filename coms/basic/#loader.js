...
var hook = function (requires_count) {
    ...
    if (document) {
        initPixelDecoder();
        if (modules.hook_time - efront_time < (isProduction ? 30 : 5) && document.querySelector && devicePixelRatio > 1 && /Linux/.test(navigator.platform) && navigator.maxTouchPoints > 0 && !/Chrome/.test(navigator.userAgent)) {
