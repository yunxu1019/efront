...
test("do{await b}while(a)", "_ = b; return [_, 1];\r\n _ = @; if (a) return [-1, 0]; return [1, 0]", true);
test("switch(a){case 1:}", "if (a === 1) return [1, 0]", true);
test("switch(a){case 1: default:}", "if (a === 1) return [1, 0]; return [1, 0]", true);
test("switch(a.a){case 1:}", "_ = a.a; if (_ === 1) return [1, 0]", true);
test("switch(a){case 1:break;}", "if (a === 1) return [1, 0];\r\n return [1, 0]", true);
test("switch(a){case 1:break;case 2:break;}", "if (a === 1) return [1, 0]; if (a === 2) return [2, 0];\r\n return [2, 0];\r\n return [1, 0]", true);
test("switch(a){case 1:case 2:break;}", "if (a === 1) return [1, 0]; if (a === 2) return [1, 0];\r\n return [1, 0]", true);
test("switch(a){case 1:case 2:x=1;}", "if (a === 1) return [1, 0]; if (a === 2) return [1, 0];\r\n x = 1", true);
test("switch(a){case 1:case 2:x=1;}", "if (a === 1) return [1, 0]; if (a === 2) return [1, 0];\r\n x = 1", true);
