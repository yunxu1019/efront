...
var getfile = require("../process/cache")(process.env.IN_TEST_MODE ? APPS_PATH : PUBLIC_PATH, filebuilder, FILE_BUFFER_SIZE);
var getfile = require("../process/filebuilder").async;
